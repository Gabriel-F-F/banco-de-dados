...
CREATE TABLE endereco (
    ...
    CONSTRAINT endereco_pk PRIMARY KEY (id_cliente, tipo),
    CONSTRAINT endereco_cliente_id_cliente_fkey FOREIGN KEY (id_cliente) REFERENCES cliente (id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (1,  2, 'RUA PESSOA FISICA 1',  1,'', 'BAIRRO PESSOA FISICA 1', 'CIDADE PESSOA FISICA 1', 'SC', '88888-881');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (2,  1, 'RUA PESSOA FISICA 2',  2,'', 'BAIRRO PESSOA FISICA 2', 'CIDADE PESSOA FISICA 2', 'SC', '88888-882');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (3,  1, 'RUA PESSOA FISICA 3',  3,'', 'BAIRRO PESSOA FISICA 3', 'CIDADE PESSOA FISICA 3', 'SC', '88888-883');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (4,  1, 'RUA PESSOA FISICA 4',  4,'', 'BAIRRO PESSOA FISICA 4', 'CIDADE PESSOA FISICA 4', 'SC', '88888-884');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (5,  1, 'RUA PESSOA FISICA 5',  5,'', 'BAIRRO PESSOA FISICA 5', 'CIDADE PESSOA FISICA 5', 'SC', '88888-885');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (6,  1, 'RUA PESSOA FISICA 6',  6,'', 'BAIRRO PESSOA FISICA 6', 'CIDADE PESSOA FISICA 6', 'SC', '88888-886');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (7,  1, 'RUA PESSOA FISICA 7',  7,'', 'BAIRRO PESSOA FISICA 7', 'CIDADE PESSOA FISICA 7', 'SC', '88888-887');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (8,  1, 'RUA PESSOA FISICA 8',  8,'', 'BAIRRO PESSOA FISICA 8', 'CIDADE PESSOA FISICA 8', 'SC', '88888-888');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (9,  1, 'RUA PESSOA FISICA 9',  9,'', 'BAIRRO PESSOA FISICA 9', 'CIDADE PESSOA FISICA 9', 'SC', '88888-889');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (10, 1, 'RUA PESSOA FISICA 10', 10, '', 'BAIRRO PESSOA FISICA 10', 'CIDADE PESSOA FISICA 10', 'SC', '88888-810');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (11, 1, 'RUA PESSOA FISICA 11', 11, '', 'BAIRRO PESSOA FISICA 11', 'CIDADE PESSOA FISICA 11', 'SC', '88888-811');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (12, 1, 'RUA PESSOA FISICA 12', 12, '', 'BAIRRO PESSOA FISICA 12', 'CIDADE PESSOA FISICA 12', 'SC', '88888-812');
INSERT INTO endereco (id_cliente, tipo, endereco, numero, complemento, bairro, cidade, estado, cep) VALUES (13, 1, 'RUA PESSOA FISICA 13', 13, '', 'BAIRRO PESSOA FISICA 13', 'CIDADE PESSOA FISICA 13', 'SC', '88888-813');
